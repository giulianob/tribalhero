...
namespace Game.Data
{
    ...
    public class Technology
    {
        ...
        public static bool CheckLocation(EffectLocation technologyLocation, EffectLocation effectPath, EffectLocation targetLocation)
        {
        ...
        public void Print()
        {
            Global.Logger.Info(string.Format("Technology type[{0}] lvl[{1}] Location[{2}]", TechBase.Techtype, TechBase.Level, OwnerLocation));
            foreach (var effect in TechBase.Effects)
                effect.Print();
        }
    }

...
{ 
    ...
    {
        Assignment CreateAssignment(ITribe tribe, uint x, uint y, ICity targetCity, AttackMode mode, DateTime targetTime, ITroopStub stub, string description, bool isAttack);

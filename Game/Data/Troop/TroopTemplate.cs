            ...
            while (itr.MoveNext())
            {
                ...
                yield return
                        new[]
                        {
                                ...
                                new DbColumn("speed", battleStats.Spd, DbType.Byte), new DbColumn("carry", battleStats.Carry, DbType.UInt16), new DbColumn("normalized_cost", battleStats.NormalizedCost, DbType.Decimal),
                        };
            }
        }

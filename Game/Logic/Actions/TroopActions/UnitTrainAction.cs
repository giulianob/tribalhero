...
namespace Game.Logic.Actions {
    class UnitTrainAction : ScheduledActiveAction {        
        ...
        public UnitTrainAction(ushort id, DateTime beginTime, DateTime nextTime, DateTime endTime, int workerType, byte workerIndex, ushort actionCount, Dictionary<string, string> properties)
        ...
        public override Error validate(string[] parms) {
            if (ushort.Parse(parms[0]) != this.type) return Error.ACTION_INVALID;
            return Error.OK;
        }
        ...
        public override void callback(object custom) {
            ...
            using (new MultiObjectLock(cityId, out city)) {
                ...
                structure.City.DefaultTroop.addUnit(Game.Fighting.FormationType.Normal, type, 1);

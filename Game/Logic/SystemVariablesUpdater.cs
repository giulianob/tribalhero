        ...
        public static void Callback(object obj) {
            lock (objLock) {
                using (Global.DbManager.GetThreadTransaction()) {
                    ...
                    if (DateTime.UtcNow.Subtract(lastUpdateScheduler).TotalSeconds < 5) return;
                    ...
                    List<SystemVariable> variables = new List<SystemVariable> {
                        ...
                        new SystemVariable("Process.memory_usage", Process.GetCurrentProcess().PeakWorkingSet64),   

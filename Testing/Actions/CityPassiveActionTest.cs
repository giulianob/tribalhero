...
namespace Testing.Actions
{
    ...
    public class CityPassiveActionTest
    {
        ...
        public void TestAlignmentPoints(decimal initialValue, int cycles, decimal expectedValue)
        {
            ...
            technologies.Setup(p => p.GetEffects(It.IsAny<EffectCode>(), It.IsAny<EffectInheritance>())).Returns(() => new List<Effect>());
...
// ReSharper restore RedundantAssignment
            ...
            CityPassiveAction action = new CityPassiveAction(1, objectTypeFactory.Object, locker.Object, formula.Object, new Mock<IActionFactory>().Object);

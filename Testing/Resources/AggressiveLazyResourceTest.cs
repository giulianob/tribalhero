...
namespace Testing.Resources {
    ...
    public class AggressiveLazyResourceTest {
        ...
        public void TestZero() {
            AggressiveLazyValue resource = new AggressiveLazyValue(0, begin, 0, 0);
        ...
        public void TestPositiveRate() {
            AggressiveLazyValue resource = new AggressiveLazyValue(0, begin, 100, 0);
        ...
        public void TestPositiveUpkeep() {
            AggressiveLazyValue resource = new AggressiveLazyValue(100, begin, 0, 100);
            SystemClock.SetClock(begin.AddMinutes(30));
        ...
        public void TestPositiveRateGreaterThanUpkeep() {
            AggressiveLazyValue resource = new AggressiveLazyValue(0, begin, 100, 50);
            SystemClock.SetClock(begin.AddMinutes(30));
        ...
        public void TestPositiveUpkeepGreaterThanRate() {
            AggressiveLazyValue resource = new AggressiveLazyValue(100, begin, 50, 100);
            SystemClock.SetClock(begin.AddMinutes(30));
        ...
        public void TestEqualUpkeepAndRate() {
            AggressiveLazyValue resource = new AggressiveLazyValue(100, begin, 100, 100);
            SystemClock.SetClock(begin.AddMinutes(30));
            Assert.AreEqual(resource.Value, 100);
        ...
        public void TestChangeUpkeep() {
            AggressiveLazyValue resource = new AggressiveLazyValue(100, begin, 100, 0);

...
:: Android packaging
set AND_CERT_NAME="TribalHero"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\TribalHero.p12
...
set IOS_PROVISION=cert\TribalHero.mobileprovision
...
set APP_ID=air.TribalHero

:: Output packages
set DIST_PATH=dist
set DIST_NAME=TribalHero

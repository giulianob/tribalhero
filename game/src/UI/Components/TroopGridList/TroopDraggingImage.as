 ...
 * @author Giuliano
 */
public class TroopDraggingImage implements DraggingImage
{
		
	private var image:Sprite;
	private var width:int;
	private var height:int;
	private var troopGridCell: TroopGridCell;
	private var icon: DisplayObject;
	private var redX: Shape;
	
	public function TroopDraggingImage(dragInitiator:Component){
		width = dragInitiator.width;
		height = dragInitiator.height;
			
		troopGridCell = TroopGridCell(dragInitiator);

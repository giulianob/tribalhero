...
public class TroopGridCell extends JLabel implements GridListCell{
		
	protected var value: *;
	
	public function TroopGridCell(){
		super();
    ...
    private function __dragRecognized(e: DragAndDropEvent) : void{
        DragManager.startDrag(this, new SourceData("dragData", {"data": value.data}), new TroopDraggingImage(e.getDragInitiator()));
    }	

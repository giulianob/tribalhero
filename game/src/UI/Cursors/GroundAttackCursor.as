package src.UI.Cursors {
	...
	public class GroundAttackCursor extends MovieClip implements IDisposable
	{
		...
		public function onMouseDoubleClick(event: MouseEvent):void
		{
			...
			Global.map.mapComm.Troop.troopAttack(city.id, gameObj.cityId, gameObj.objectId, mode, troop);
		...
		public function validate():void
		{
			...
			{
				Global.map.gameContainer.message.showMessage("Choose target to attack");
			}
			else
			{
				...
				Global.map.gameContainer.message.showMessage("About " + Util.niceTime(timeAwayInSeconds) + " away. Double click to attack.");
			}
		}
	}

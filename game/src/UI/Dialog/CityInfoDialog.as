...
package src.UI.Dialog {
	...
	import src.Objects.*;
	import src.UI.Components.TileListDragDrop.TileListDragDropHandler;
	...
	public class CityInfoDialog extends Dialog implements IDisposable {
		...
		{			
			...
			city.troops.addEventListener(BinaryList.CHANGED, onTroopUpdate);
		...
		private function draw():void
		{
			...
			{				
				...
				var item: Object;
				if (troop.id == 1)				
					item = { Troops: "Local Troop", id: troop.id, data: troop };				
				else
					item = { Troops: "Troop " + troop.id, id: troop.id, data: troop };
		...
		{									
			...
			cursor.init(map, troop, dialog.getMode(), city.id);
		...
		public function dispose():void
		{
			if (city != null)
			{
				city.troops.removeEventListener(BinaryList.CHANGED, onTroopUpdate);

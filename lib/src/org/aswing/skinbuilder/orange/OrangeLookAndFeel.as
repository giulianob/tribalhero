...
package org.aswing.skinbuilder.orange{
	...
	public class OrangeLookAndFeel extends BasicLookAndFeel{
		...
		[Embed(source="assets/Frame_inactiveBG.png", scaleGridTop="66", scaleGridBottom="350",
		scaleGridLeft="128", scaleGridRight="668")]
		...
		override protected function initComponentDefaults(table:UIDefaults):void{
			...
			"ToggleButton.margin", new InsetsUIResource(4, 4, 4, 4) //modify this to fit the image border margin
			];
			table.putDefaults(comDefaults);

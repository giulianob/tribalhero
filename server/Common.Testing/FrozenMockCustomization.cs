...
{
    public class FrozenMockCustomization : ICustomization
    {
        ...
        /// </exception>
        public FrozenMockCustomization(Type targetType)
        ...
        /// </exception>
        public FrozenMockCustomization(Type targetType, Type registeredType)
        {
            if (targetType == null)
            {

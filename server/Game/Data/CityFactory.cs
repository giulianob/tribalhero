...
namespace Game.Data
{
    public class CityFactory : ICityFactory
    {
        ...
        public ICity CreateCity(uint id, IPlayer owner, string name, Position position, Resource resource, byte radius, decimal ap, string defaultTheme, string roadTheme, string wallTheme, string troopTheme)
        {
